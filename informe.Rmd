...
Como $t=`r summary(reg)$coefficients[2,3]`$ es `r tex<-"menor"; if(summary(reg)$coefficients[2,3]>qt(0.975,(nrow(data)-2))) tex<-"mayor"; tex` que $t_{`r (nrow(data)-2)`}(\frac{1-\alpha}{2})= `r qt(0.975,(nrow(data)-2))`$
